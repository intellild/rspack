  ...
  apply(compiler) {
    compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
      compilation.hooks.afterProcessAssets.tap(PLUGIN_NAME, () => {
        ...
        // Issue #15246 reaches the same state with a css/auto module. Webpack
        // throws a catchable JavaScript error when a chunkless module has no
        // code generation result; Rspack must not abort the process.
        expect(() =>
